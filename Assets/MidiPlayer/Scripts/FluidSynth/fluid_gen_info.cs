...
namespace MidiPlayerTK
{
    public class fluid_gen_info
    {
        ...
        public static fluid_gen_info[] FluidGenInfo = new fluid_gen_info[]
        {
            ...
            new fluid_gen_info((int) fluid_gen_type.GEN_SCALETUNE,              0,     1,       0.0f,   1200.0f,     100.0f, true, "Scale tuning"),
            ...
            new fluid_gen_info((int) fluid_gen_type.GEN_PITCH,                  1,     0,       0.0f,    127.0f,       0.0f, true, "Pitch"),
     };
