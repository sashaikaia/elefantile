...
namespace MidiPlayerTK
{
    ...
    public partial class MPTKEvent : ICloneable
    {
        ...
        /// <summary>
        /// Duration of the note in Midi Tick. MidiFilePlayer.MPTK_NoteLength can be used to convert this duration. Not used for MidiStreamPlayer, length is set only when reading a Midi file.
        ...
        /// </summary>
        public long MPTK_DeltaTimeTick { get { return DateTime.Now.Ticks - TickTime; } }
